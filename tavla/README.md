...
- Zar atımı için pop-up yoktur; bilgi alt menüdeki yazı alanında gösterilir.
- Metin yerine zar yüzleri için görsel zar arayüzü.
- Bir pul seçince, kurallara uygunsa iki zarın toplamına denk gelen hedefe tek tıkla gidebilme (hamle kısayolu).
...
- Hamle onayı pop-up olmadan doğrudan butonla yapılır ve sıra rakibe geçer.
